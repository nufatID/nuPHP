...
switch ($command) {
    ...
    case 'version':
    case '-v':
        echo "nuPHP Framework Version 2.0.0 (PHP " . PHP_VERSION . ")\n";
        break;
    ...
    default:
        if (class_exists('Nufat\Cli\CliHandler')) {
            ...
            echo "\033[34mnuPHP CLI Tool v2.0.0\033[0m\n\n";
            echo "Usage:\n";
            echo "  php nu serve [port]          Start local development server (default: 8000)\n";
            echo "  php nu make:controller <Name> Create a new Controller in app/Controllers\n";
            echo "  php nu make:model <Name>      Create a new Eloquent Model in app/Models\n";
