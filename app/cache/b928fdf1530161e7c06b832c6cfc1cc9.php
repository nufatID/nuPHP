        ...
        <div class="container-fluid">
            <div class="branding">
                <h1 class="logo">
                    ...
                    <span class="text-highlight">NUphp</span><span class="text-bold">Framework</span>
                </h1>
            </div>
            <!--//branding-->
            <div class="tagline">
...
<?php $__currentLoopData = $mod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <p>This is user <?php echo e($mod->nama); ?></p>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myframework\app\views/index.blade.php ENDPATH**/ ?>