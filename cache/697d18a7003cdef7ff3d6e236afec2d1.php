        ...
        <div class="container-fluid">
            <div class="branding">
                <h1 class="logo">
                    ...
                    <span class="text-highlight"><?php echo e($name); ?></span><span class="text-bold">Framework</span>
                </h1>
            </div>
            <!--//branding-->
            <div class="tagline">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kas\templates/index.blade.php ENDPATH**/ ?>